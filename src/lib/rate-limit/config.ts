...
export function getRateLimitConfig(): RateLimitConfig {
  return {
    ...
    authIpMax: parseEnvInt("RATE_LIMIT_AUTH_IP_MAX", 20),
    authIpWindowSec: parseEnvInt("RATE_LIMIT_AUTH_IP_WINDOW_SEC", 60),
    authAccountMax: parseEnvInt("RATE_LIMIT_AUTH_ACCOUNT_MAX", 20),
    ...
    publicMax: parseEnvInt("RATE_LIMIT_PUBLIC_MAX", 120),
    publicWindowSec: parseEnvInt("RATE_LIMIT_PUBLIC_WINDOW_SEC", 60),

    // Authenticated User Endpoints (loose)
    authenticatedMax: parseEnvInt("RATE_LIMIT_AUTHENTICATED_MAX", 300),
    ...
    strictMax: parseEnvInt("RATE_LIMIT_STRICT_MAX", 30),
