      ...
      <Container size="default" className="relative z-10">
        ...
        >
          ...
          <div className="flex flex-col items-center gap-5">
            {/* Top Eyebrow Badge */}
            <span className="inline-flex items-center gap-2 rounded-full bg-gold-500/15 border border-gold-500/40 px-5 py-1.5 text-xs sm:text-sm md:text-base font-bold uppercase tracking-[0.16em] text-gold-300">
            ...
            <div className="mt-4 flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
              ...
              <a
                href="https://wa.me/919073190525?text=Hello%20Vrikszon%20Occultaura,%20I%20would%20like%20to%20book%20a%20consultation."
                target="_blank"
