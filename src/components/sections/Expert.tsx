        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-[0.9fr_1.1fr] lg:gap-12 items-start">
          ...
          <div className="flex flex-col items-start gap-6 text-left">
            ...
            <div className="flex flex-col gap-2">
              <motion.h2
                {...fadeUp(0.08)}
                className="font-heading text-h2 sm:text-h1 md:text-hero text-[28px] sm:text-[36px] md:text-[44px] lg:text-[50px] font-semibold text-navy-950 tracking-tight leading-[1.18]"
              >
