 ...
 * ServicesHero
 *
 * Dark, atmospheric hero section for the Services catalog page (/services).
...
const ServicesHero = () => {
  ...
  return (
    <section
      aria-label="Services offered by Vrikszon Occultaura"
      className="relative overflow-hidden py-20 md:py-24 lg:py-30"
    >
      {/* Background — purely decorative: gradient + subtle dot grid + gold glow */}
      ...
      <Container size="wide" className="relative z-10">
        <div className="mx-auto flex max-w-reading flex-col items-center gap-4 text-center">
          ...
          <motion.nav {...fadeUp(0)} aria-label="Breadcrumb" className="mb-2">
            <ol className="flex items-center gap-2 text-small text-white/60">
              <li>
                <Link
                  href="/"
                  className="rounded-sm transition-colors duration-[200ms] ease-out hover:text-gold-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold-500 focus-visible:ring-offset-2 focus-visible:ring-offset-navy-900"
                >
                  Home
                </Link>
              </li>
          ...
          >
            Explore our comprehensive spectrum of Numerology, Vastu, KP Astrology, and custom remedial guidance — designed to help you navigate life, relationships, career, and space with clarity and balance.
          </motion.p>
        </div>
      </Container>
    </section>
