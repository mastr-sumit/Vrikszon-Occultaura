...
## Project-Specific UI/UX Guidelines (Vrikszon Occultaura)

**IMPORTANT: Before any UI/UX work on this project, read the full project-specific guidelines:**

See: `references/ui-ux-guidelines.md`

This reference document is the **authoritative source of truth** for all design decisions on the Vrikszon Occultaura premium numerology & astrology website. It covers:

- **Mission**: Build trust within 5 seconds, guide users naturally, maximize consultation bookings
- **Core Design Philosophy**: Luxury, atmospheric, spiritual, premium-but-maximalist (not minimal), ornate & mystical — full-bleed cosmic imagery, decorative flourishes, bold typography
- **First Impression Rule**: Who we are → What we do → Why trust us → How to book (within 5 seconds)
- **Visual Hierarchy**: Primary Focus → Secondary Info → Supporting Info → CTA (never compete for attention)
- **Layout Density & Atmosphere**: Dense confident layouts, full-bleed cosmic backgrounds, high impact typography
- **Reading Experience**: Max 760px text width, 2–4 line paragraphs, frequent headings
- **Layout Rules**: Alternate Image Left → Image Right → Cards → Timeline → CTA
- **Section Structure**: Small Label → Headline → Supporting Text → Visual → CTA
- **Hero Rules**: Must answer who/what/why/action, include headline, subheading, dual CTAs, trust indicators, background visual, scroll cue
- **Navigation Rules**: Max 7 items, sticky, always-visible CTA, transparent over hero → solid after scroll
- **CTA Rules**: Primary = "Book Consultation", Secondary = "WhatsApp", must appear in hero/services/testimonials/footer
- **Card Design**: Simple, rounded, spacious, soft shadows, clear icons, readable, hover states — avoid overload
- **Forms**: Minimum fields, clear labels, inline validation, large inputs/submit, success confirmation
- **Typography**: Hierarchy via typography (not just color), meaning before decoration, excellent readability
- **Color Usage**: 60% primary / 30% neutral / 10% accent — accent highlights important actions only
- **Trust Building**: Years of experience, testimonials, Google reviews, certifications, awards, media mentions
- **User Journey**: Visitor → Hero → Trust → Services → Benefits → Testimonials → FAQ → Book Consultation
- **Conversion**: Reduce friction, remove unnecessary clicks, build trust before asking for action, benefits before features
- **Mobile UX**: Mobile-first, thumb-friendly, readable, simple nav, fast loading, no horizontal scroll
- **Accessibility**: Keyboard nav, visible focus, alt text, heading hierarchy, contrast, large tap targets
- **Performance UX**: Skeleton loaders, lazy loading, progress indicators, smooth transitions, no layout shifts
- **Empty States**: Every empty screen must explain situation, offer guidance, provide next action
- **Error Handling**: Human-friendly messages, never blame user, explain fix
- **Loading Experience**: Show progress, avoid blank screens, subtle animations
- **Micro Interactions**: Buttons/cards hover, inputs focus, navigation active states — feedback feels instant
- **Premium Feel Checklist**: Consistent spacing, large typography, soft shadows, elegant animations, strong hierarchy, minimal clutter, high-quality imagery, smooth scrolling, clear CTAs, accessible
- **User Psychology**: People buy trust before services, reduce anxiety, guide don't force — answer "Why us? Why now? What happens next?"
- **Don'ts**: No page overload, max two fonts, don't animate everything, no bright saturated colors, no unnecessary complexity, never hide important info
- **Golden Rule**: Every design decision must improve at least one of: Trust, Readability, Accessibility, Conversion, Performance, User Experience — if it improves none, don't implement it
